  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editTeamsModalLabel<?php echo $team['team_id']; ?>">Edit Team</h1>
      ...
      <form method = "post" action="">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="tSeasonYear<?php echo $team['team_id']; ?>" name="tSeasonYear" value="<?php echo $team['season_year']; ?>">
          </div>
          <div class="mb-3">
            <label for="tWins<?php echo $team['team_id']; ?>" class="form-label">Wins</label>
            <input type="text" class="form-control" id="tWins<?php echo $team['team_id']; ?>" name="tWins" value="<?php echo $team['win']; ?>">
          </div>
          <div class="mb-3">
